...
#Job Description: NZ30sec bathymetry, Spherical Coordinates for code testing
 Total run time (Wall clock, seconds)           :   5400.0
 ...
 Resuming Time If hot start (Seconds)           :     0.0 , 0.25
...
#===============================================:===============================
 ...
 Focal Depth                             (meter):  28000.000
 Length of source area                   (meter):  300000.000
 Width of source area                    (meter):  144543.977
 Dislocation of fault plate              (meter):  15.849
 Strike direction (theta)               (degree):  329.00
 Dip  angle       (delta)               (degree):  8.00
 Slip angle       (lambda)              (degree):  110.00
 Origin of Comp. Domain (Layer 01) (Lon, degree):   1.31
 Origin of Comp. Domain (Layer 01) (Lat, degree):  90.29
 Epicenter Location: Latitude           (degree):  3.3167
 Epicenter Location: Longitude          (degree):  95.8547
 File Name of Deformation Data                  :  data-thrust.txt
 Data Format Option (0-COMCOT; 1-MOST; 2-XYZ)   :     2

#===============================================:===============================
#  Parameters for Wave Maker                    :Values                        |
#===============================================:===============================
 Wave type  ( 1:Solit, 2:given, 3:focusing )    :     3
...
#===============================================:===============================
 ...
 Grid Size  (dx, sph:minute, cart:meter)        :     0.25
 Time step                            ( second ):     5.0
 ...
 Y_start                                        :   1.31
 Y_end                                          :   8.54
 File Name of Bathymetry Data                   :aa.xyz
